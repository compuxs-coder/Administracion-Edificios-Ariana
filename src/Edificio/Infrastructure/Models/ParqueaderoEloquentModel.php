...
final class ParqueaderoEloquentModel extends Model
{
    ...
    {
        return $this->qualifiedTable('parqueaderos');
    }
    ...
    {
        return $this->hasMany(DepartamentoParqueaderoEloquentModel::class, 'parqueadero_id');
    }
